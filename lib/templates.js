...
module.exports = {
  worksheet: {
    header: function(opts) {
      var colIdx, colsTag, decoded, frozenCell, i, minMax, options, rangePattern, sheetView, width, _i, _len, _ref, _ref1;
      options = opts || {};
    ...
    footer: function(sheet) {
      return xml("  </sheetData>" + (sheet.comments.length ? '\n<legacyDrawing r:id="rId1" />' : '') + "\n</worksheet>");
    }
  },
  sheet_related: {
    "[Content_Types].xml": {
