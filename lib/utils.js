var compress, computeColIndex, escapeXML, msPerDay, toOADate, zeroLocal, _;
...
module.exports = {
  ...
  buildCell: function(ref, val, styles, opts) {
  ...
  rangePatternToMinMax: function(rangePattern, max) {
    var splitPattern;
